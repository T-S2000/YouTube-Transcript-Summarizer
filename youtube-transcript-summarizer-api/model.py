...
def nlp_model(v_id):
    ...
    if (transcript == '0'):
        ...
        malayalam_translated_summary = g_translate(english_summary, 'ml')

        # print(original_text_length, '-->', final_summary_length)
        # print(final_smy)

        makeTextFile("English", english_summary)
        makeTextFile("Malayalam", malayalam_translated_summary)

        return original_text_length, final_summary_length, english_summary, malayalam_translated_summary
